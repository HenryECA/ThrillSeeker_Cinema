...
export async function UpdateFilmReview(film, user, rating) {
    const path = "http://127.0.0.1:7000/film/userReview/";
...
export async function RetrieveFilmList(){
    ...
    const path = "http://127.0.0.1:7000/films/";
...
export async function UpdateFilmInfo(index, film){
    ...
    const path = "http://127.0.0.1:7000/films/" + index + "/update/";
...
export async function DeleteFilm(index){
    ...
    const path = "http://127.0.0.1:7000/films/" + index + "/delete/"
