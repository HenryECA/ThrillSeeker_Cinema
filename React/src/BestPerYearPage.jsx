    ...
    useEffect(() => {
      const fetchFilms = async () => {
        try {
          ...
          // const response = await fetch(`http://127.0.0.1:7000/?release_year=${yearfilter}&ordering=-rt_score&limit=10`);
          // console.log(`http://127.0.0.1:7000/?release_year=${yearfilter}&ordering=-rt_score&limit=10`);
